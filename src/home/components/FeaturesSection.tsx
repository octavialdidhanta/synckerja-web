      ...
      <div className="container mx-auto px-4">
        <div className="text-left md:text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-muted-foreground">
            HCM terintegrasi dari rekrutmen, absensi, payroll, OKR system, CRM, membantu Anda memantau performance, produktivitas, dan kepatuhan, lalu mengambil keputusan lebih cepat tanpa tenggelam dalam detail operasional harian.
          </p>
        </div>
        <div className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 overflow-x-auto md:overflow-visible pb-4 md:pb-0 -mx-4 md:mx-0 px-4 md:px-0 scrollbar-hide">
          {features.map((f) => (
            <div
              key={f.title}
